...
def create_gesture(filename, syllable, speaker, pitch_var=0.0, len_var=1.0):
 ...
 file.write('    <gesture value="'+vowel+'" slope="0.000000" duration_s="'+duration_s+'" time_constant_s="'+time_constant_s+'" neutral="0" />\n')
