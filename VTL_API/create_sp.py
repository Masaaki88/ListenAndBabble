...
def create_speaker(filename, params):	# main function takes output file name and returns output file name with output path
					                    #  params: float[18] vector for vocal tract configuration

 filename_ = pth.relpath('VTL_API/speakers/'+filename+'.speaker')
