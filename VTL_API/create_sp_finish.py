...
def create_speaker_finish(speaker, motor_memory, folder, verbose=False):	# main function takes output file name and returns output file name with output path
 ...
 filename_ = pth.relpath(folder+'finished.speaker')
 ...
 for vowel in motor_memory:
    dic = get_dic(vowel[1])             # get parameter dictionary
    file.write('''      <shape name="'''+vowel[0]+'''">
